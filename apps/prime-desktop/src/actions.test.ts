...
describe('actions', () => {
  it('registers and searches actions', () => {
    registerAction({ id: 'a1', label: 'Open DAG Board', keywords: ['dag', 'board'], run: () => {} })
    registerAction({ id: 'a2', label: 'Open Kernel', keywords: ['kernel'], run: () => {} })
  ...
  it('matches by keyword', () => {
    registerAction({ id: 'cost', label: 'Cost Breakdown', keywords: ['tokens', 'usage'], run: () => {} })
